...
const Banner = ( ) => {
  return (
    <div className='flex flex-col-reverse lg:flex-row items-center justify-between px-6 lg:pl-28 xl:pl-48 banner-bg rounded-3xl mx-2 lg:mx-0 h-[600px] font-playfair mt-8 lg:mt-[52px]'>
      <div className='pb-10'>
